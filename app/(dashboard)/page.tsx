      ...
      <div>
        ...
        <div className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-3">
          <Link
            ...
            className="rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-4 hover:bg-zinc-100"
          >
            <div className="text-sm font-semibold">Create ingest endpoint</div>
            <div className="mt-1 text-xs text-zinc-600">Tokenized URL for scripts/services.</div>
          </Link>
          <Link
            href="/channels"
            className="rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-4 hover:bg-zinc-100"
          >
            ...
            <div className="mt-1 text-xs text-zinc-600">Point at any Bark server.</div>
          </Link>
          <Link
            href="/rules"
            className="rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-4 hover:bg-zinc-100"
          >
            ...
            <div className="mt-1 text-xs text-zinc-600">Match messages and forward.</div>
          </Link>
        </div>
      </div>
